...
public class BoardStatistics {
	...
	/**
	 * @return the matchesWonByResistance
	 */
	...
	/**
	 * @param matchesWonByResistance the matchesWonByResistance to set
	 */
	...
	/**
	 * @param matchesPlayed3v2 the matchesPlayed3v2 to set
	 */
	...
	/**
	 * @return the matchesWonByResistance3v2
	 */
	...
	/**
	 * @param matchesWonByResistance3v2 the matchesWonByResistance3v2 to set
	 */
	...
	/**
	 * @param matchesPlayed4v2 the matchesPlayed4v2 to set
	 */
	...
	/**
	 * @return the matchesWonByResistance4v2
	 */
	...
	/**
	 * @param matchesWonByResistance4v2 the matchesWonByResistance4v2 to set
	 */
	...
	/**
	 * @param matchesPlayed4v3 the matchesPlayed4v3 to set
	 */
	...
	/**
	 * @return the matchesWonByResistance4v3
	 */
	...
	/**
	 * @param matchesWonByResistance4v3 the matchesWonByResistance4v3 to set
	 */
	...
	/**
	 * @param matchesPlayed5v3 the matchesPlayed5v3 to set
	 */
	...
	/**
	 * @return the matchesWonByResistance5v3
	 */
	...
	/**
	 * @param matchesWonByResistance5v3 the matchesWonByResistance5v3 to set
	 */
	...
	/**
	 * @param matchesPlayed6v4 the matchesPlayed6v4 to set
	 */
	...
	/**
	 * @return the matchesWonByResistance6v4
	 */
	...
	/**
	 * @param matchesWonByResistance6v4 the matchesWonByResistance6v4 to set
	 */
	...
	/**
	 * @param matchesPlayed6v3 the matchesPlayed6v3 to set
	 */
	...
	/**
	 * @return the matchesWonByResistance6v3
	 */
	...
	/**
	 * @param matchesWonByResistance6v3 the matchesWonByResistance6v3 to set
	 */
